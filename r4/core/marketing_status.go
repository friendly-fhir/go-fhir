...
func (m *MarketingStatus) GetCountry() *CodeableConcept {
	if m == nil {
		return nil
	}
	return m.Country
...
func (m *MarketingStatus) GetDateRange() *Period {
	if m == nil {
		return nil
	}
	return m.DateRange
...
func (m *MarketingStatus) GetExtension() []*Extension {
	if m == nil {
		return nil
	}
	return m.Extension
...
func (m *MarketingStatus) GetId() string {
	if m == nil {
		return ""
	}
	return m.Id
...
func (m *MarketingStatus) GetJurisdiction() *CodeableConcept {
	if m == nil {
		return nil
	}
...
func (m *MarketingStatus) GetModifierExtension() []*Extension {
	if m == nil {
		return nil
	}
...
func (m *MarketingStatus) GetRestoreDate() *DateTime {
	if m == nil {
		return nil
	}
...
func (m *MarketingStatus) GetStatus() *CodeableConcept {
	if m == nil {
		return nil
	}
	return m.Status
